	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/macro.jpg" width="250px" height="300px">
                <br>
                    <p align="right" style="font-size:15px; color:black;">Cost of rent: $100</p>
                    <p align="right" style="font-size:15px">Cost of fee: $5.30</p>
                   <strong> <p align="right" style="font-size:19px">Total: $10000</p></strong>
                </div>
                <div class="container-names">
                    <h1>Macroeconomics<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 978006040</i>
                    <br>
