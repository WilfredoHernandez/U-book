	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/Strategic Management.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>Strategic Management<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 1260092372</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $54.99<strong></p>
                    <br>
                    ...
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $66.59<strong></p>
                    <br>
                    <hr class="divider my-4">
