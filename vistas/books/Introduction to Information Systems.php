	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/Introduction to Information Systems.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>Introduction to Information Systems<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 1119403502</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $107.43<strong></p>
                    <br>
                    <p align="right">cost of fee: $5.30<strong></p>
                    <br>
                    <p align="right">cost of transportation: $6.30<strong></p>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $119.03<strong></p>
                    <br>
                    <hr class="divider my-4">
