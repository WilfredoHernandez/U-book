	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/Marketing Managment.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>Marketing Managment<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 1337271128</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $95.22<strong></p>
                    <br>
                    <p align="right">cost of fee: $5.30<strong></p>
                    <br>
                    <p align="right">cost of transportation: $6.20<strong></p>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $106.72<strong></p>
                    <br>
                    <hr class="divider my-4">
