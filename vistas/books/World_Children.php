	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/The World of Children.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>The World of Children<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 0205940145</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $89.99<strong></p>
                    <br>
                    ...
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $101.59<strong></p>
                    <br>
                    <hr class="divider my-4">
