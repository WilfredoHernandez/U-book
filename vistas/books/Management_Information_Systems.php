...
<html lang="en">
<head>
	<title>Managment Information Systems</title>
	<meta charset="UTF-8">
		...
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <div class="container-names">
                    ...
                    <br>
                    <i style="color:gray;">ISBN: 0619062509 </i>
                    <br>
                    ...
                    <div class="container-card">
                        ...
                        <input type="text" name="id_libro" id="id_libro" value="9" style="background-color:lightblue" hidden>
                        <br><br><br>
