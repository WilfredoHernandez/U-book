	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/Macroeconomics Essentials.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>Macroeconomics Essentials<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 0262533340</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $51.99<strong></p>
                    <br>
                    <p align="right">cost of fee: $5.30<strong></p>
                    <br>
                    <p align="right">cost of transportation: $3.99<strong></p>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $61.28<strong></p>
                    <br>
                    <hr class="divider my-4">
