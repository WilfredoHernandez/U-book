	...
	<div class="limiter">
		<div class="container-renta100">
			<div class="wrap-renta100">
                ...
                <img src="../../img/Corporate Finance.jpg" width="250px" height="300px">
                </div>
                <div class="container-names">
                    <h1>Corporate Finance<strong></h1>
                    <br>
                    <i style="color:gray;">ISBN: 1260091872</i>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">Cost of rent: $75.00<strong></p>
                    <br>
                    <p align="right">cost of fee: $5.30<strong></p>
                    <br>
                    <p align="right">cost of transportation: $5.30<strong></p>
                    <br>
                    <hr class="divider my-4">
                    <br>
                    <p align="right">total: $85.6<strong></p>
                    <br>
                    <hr class="divider my-4">
